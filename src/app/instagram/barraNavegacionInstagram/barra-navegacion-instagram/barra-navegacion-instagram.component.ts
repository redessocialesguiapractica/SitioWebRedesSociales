...
@Component({
  selector: 'app-barra-navegacion-instagram',
  templateUrl: './barra-navegacion-instagram.component.html',
  styleUrls: ['./barra-navegacion-instagram.component.css']
})
export class BarraNavegacionInstagramComponent {
