...
@Component({
  selector: 'app-busqueda-instagram',
  templateUrl: './busqueda-instagram.component.html',
  styleUrls: ['./busqueda-instagram.component.css']
})
export class BusquedaInstagramComponent {
