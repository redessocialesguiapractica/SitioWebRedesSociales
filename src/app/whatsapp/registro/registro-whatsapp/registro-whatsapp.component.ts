...
@Component({
  selector: 'app-registro-whatsapp',
  templateUrl: './registro-whatsapp.component.html',
  styleUrls: ['./registro-whatsapp.component.css']
})
export class RegistroWhatsappComponent {
